...
JavaScript (Vanilla JS): Event listener, filter, dan kalkulasi harga

Simulasi loading pada tombol.

Font Awesome & Bootstrap Icons: Untuk ikonografi di seluruh situs.

Google Fonts: Menggunakan font 'Outfit' untuk tipografi.
